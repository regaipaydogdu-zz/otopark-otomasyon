...
{
    public partial class mistarguncel : Form
    {
        public mistarguncel()
        {
            InitializeComponent();
        ...
        public void UcretGuncelle()
        {
            ...
            {
                baglanti.Open();
                OleDbCommand komut = new OleDbCommand("update tarifeler set sifirbir='" + kul01.Text + "', biruc='" + kul13.Text + "',ucalti='" + kul36.Text + "',altioniki='" + kul612.Text + "',onikiyirmidort='" + kul1224.Text + "',yirmidortkirksekiz='" + kul2448.Text + "',kirksekizyetmisiki='" + kul4872.Text + "',yuz='" + kuldiger.Text + "' where musteritur='misafir' ", baglanti);
