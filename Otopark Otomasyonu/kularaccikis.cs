...
{
    public partial class kularaccikis : Form
    {
        DateTime tarih;
        string parkyeri = "";
        ...
        {
            comboBox1.Text = KayitliKulAnaMenu.girilen_plaka;
        ...
        private void kularaccikis_Load(object sender, EventArgs e)
        {
            AracBilgiGetir();
        }
        ...
        private void pdYazici2_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("----------------------------------------------------------------------------", baslik, sb, 100, 100);
            e.Graphics.DrawString("KAYITLI KULLANICI TARİFE ", baslik2, sb, 100, 135);
            e.Graphics.DrawString("0-1 TSaat Aralığı ", baslik, sb, 100, 200);
            ...
            e.Graphics.DrawString("MİSAFİR KULLANICI TARİFE ", baslik2, sb, 100, 640);
